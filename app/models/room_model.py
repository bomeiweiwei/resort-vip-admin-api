from sqlalchemy import Column, Unicode, Integer, String, Boolean, DateTime, ForeignKey
...
class RoomType(Base):
    ...
    description = Column("Description", Unicode(500), nullable=True)
...
class Room(Base):
    ...
    room_no = Column("RoomNo", Unicode(20), nullable=False)
